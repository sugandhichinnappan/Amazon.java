...
System.setProperty("webdriver.chrome.driver", "chromedriver.exe");
	...
	public void Mulitplefilter() {
		...
		driver.findElement(By.cssSelector("#p_n_feature_five_browse-bin\\/10366966011 > span > a > span > div")).click();
	    driver.findElement(By.cssSelector("#a-autoid-14-announce > span")).click();
	}
	@AfterMethod
